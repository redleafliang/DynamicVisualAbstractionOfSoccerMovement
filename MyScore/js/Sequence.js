...
function redrawPitch(ComputeResult, MethodName) {
...
function hydraw(value) {
    ...
    switch (value){
        case 0:
            clearPitch();
            result = hyDrawPoints;
            redrawPitch(result,"normal");
            break;
        case 10:
            clearPitch();
            result = CatmullRomChain(hyDrawPoints);
            redrawPitch(result,"CatmullRom");
            break;
        case 20:
            clearPitch();
            result = SIA(hyDrawPoints, 1, 1);
            redrawPitch(result,"SIA");
            break;
        case 30:
            clearPitch();
        ...
        case 60:
            ...
            redrawPitch(result,"bezier curve");
            break;
        case 70:
            clearPitch();
        ...
        case 120:
            ...
            redrawPitch(result,CLUSTERALGORITHMMODE);
            break;
        case 130:
            clearPitch();
